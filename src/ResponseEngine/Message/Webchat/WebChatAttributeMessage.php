...
class WebChatAttributeMessage extends WebChatMessage
{
    protected $messageType = 'attribute';
    ...
    /**
     * Sets text for a standard Web Chat attribute message.
     * The main text is escaped.
     *
