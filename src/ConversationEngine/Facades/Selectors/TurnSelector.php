 ...
 * @method static TurnCollection selectTurnsByValidOrigin(SceneCollection $scenes, string $validOrigin, bool $shallow = true)
 * @method static Turn selectTurnById(string $turnId, bool $shallow = true)
