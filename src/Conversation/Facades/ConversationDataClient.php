 ...
 * @method static Conversation getConversationById(string $conversationId, bool $shallow)
 ...
 * @method static Scene getSceneById(string $sceneId, bool $shallow)
 ...
 * @method static Turn getTurnById(string $turnId, bool $shallow)
